        ...
        >
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              ...
              แจ้ง บริการที่คุณสนใจ พื้นที่หน้างาน เพื่อประเมินราคาเบื้องต้น
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="ds-muted text-sm line-clamp-2">
              นัดหมายเข้าวัดพื้นที่หน้างานอย่างละเอียด
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="ds-muted text-sm line-clamp-2">
              เลือกชมตัวอย่างวัสดุหลากหลายเกรด พร้อมสรุปแบบและราคา
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="ds-muted text-sm line-clamp-2">
              ติดตั้งรวดเร็วโดยทีมช่างมืออาชีพ ตรวจสอบความเรียบร้อย และส่งมอบ
              </p>
            </div>
          </div>
        </div>
